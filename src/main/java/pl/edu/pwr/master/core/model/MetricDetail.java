package pl.edu.pwr.master.core.model;
...
public class MetricDetail {
    ...
    private MetricDetail(String packageName, String className, String methodSignature, String outerClassName, String accessModifier, Boolean isStatic, Boolean isFinal) {
    ...
    public static class MetricDetailBuilder {
        ...
        public MetricDetail build() {
            return new MetricDetail(packageName, className, methodSignature,
                    outerClassName, accessModifier, isStatic, isFinal);
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(packageName, className, methodSignature, outerClassName, accessModifier, isStatic, isFinal);
    }
}
